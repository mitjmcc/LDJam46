Shader "Toon/Lit Tri Planar Normal" {
	Properties{
		...
		_MatcapTex("Top Texture", 2D) = "white" {}
...
#pragma lighting ToonRamp exclude_path:prepass
	...
	sampler2D _MainTex, _MainTexSide, _Normal, _Noise, _NormalT, _MatcapTex;
	...
	void surf(Input IN, inout SurfaceOutput o) {
		...
		float2 matcapUV = IN.viewDir.yx * 0.5 + 0.5;
		...
		float3 matcapTexture = tex2D(_MatcapTex, matcapUV);
