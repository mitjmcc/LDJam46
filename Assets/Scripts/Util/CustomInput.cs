namespace GGJ2020.Util
{
    ...
    public class CustomInput : MonoBehaviour
    {
        ...
        {
            Up, Down, Left, Right, Pause, Accept, Cancel, Jab, Strong, Fierce, Move, Guard, Special, Grab, None
        }
        ...
        public static void RawSign()
        {
            ...
            rawSign[(int)UserInput.Jab] = 1;
            rawSign[(int)UserInput.Strong] = 1;
            rawSign[(int)UserInput.Fierce] = 1;
            rawSign[(int)UserInput.Move] = 1;
            rawSign[(int)UserInput.Guard] = 1;
            rawSign[(int)UserInput.Special] = 1;
        }
        ...
        public static void DefaultKey()
        {
            ...
            keyboard[(int)UserInput.Jab, 0] = KeyCode.U;
            keyboard[(int)UserInput.Strong, 0] = KeyCode.I;
            keyboard[(int)UserInput.Fierce, 0] = KeyCode.O;
            keyboard[(int)UserInput.Move, 0] = KeyCode.J;
            keyboard[(int)UserInput.Guard, 0] = KeyCode.K;
            keyboard[(int)UserInput.Special, 0] = KeyCode.L;
            ...
            keyboard[(int)UserInput.Pause, 1] = KeyCode.Space;
            keyboard[(int)UserInput.Accept, 1] = KeyCode.Return;
            keyboard[(int)UserInput.Cancel, 1] = KeyCode.Escape;
            keyboard[(int)UserInput.Jab, 1] = KeyCode.U;
            keyboard[(int)UserInput.Strong, 1] = KeyCode.I;
            keyboard[(int)UserInput.Fierce, 1] = KeyCode.O;
            keyboard[(int)UserInput.Move, 1] = KeyCode.J;
            keyboard[(int)UserInput.Guard, 1] = KeyCode.K;

            keyboard[(int)UserInput.Accept, 2] = KeyCode.Return;
            keyboard[(int)UserInput.Cancel, 2] = KeyCode.Escape;
        }
        ...
        public static void DefaultPad()
        {
            ...
            gamepad[(int)UserInput.Jab, 0] = A;
            gamepad[(int)UserInput.Strong, 0] = X;
            gamepad[(int)UserInput.Fierce, 0] = Y;
            gamepad[(int)UserInput.Move, 0] = RB;
            gamepad[(int)UserInput.Guard, 0] = LB;
            gamepad[(int)UserInput.Special, 0] = B;
            ...
            gamepad[(int)UserInput.Jab, 1] = A;
            gamepad[(int)UserInput.Strong, 1] = X;
            gamepad[(int)UserInput.Fierce, 1] = Y;
            gamepad[(int)UserInput.Move, 1] = RB;
            gamepad[(int)UserInput.Guard, 1] = LB;
            gamepad[(int)UserInput.Special, 1] = B;

            gamepad[(int)UserInput.Up, 2] = LEFT_STICK_UP;
            gamepad[(int)UserInput.Down, 2] = LEFT_STICK_DOWN;
            gamepad[(int)UserInput.Left, 2] = LEFT_STICK_LEFT;
            gamepad[(int)UserInput.Right, 2] = LEFT_STICK_RIGHT;
            gamepad[(int)UserInput.Pause, 2] = START;
            gamepad[(int)UserInput.Accept, 2] = A;
            gamepad[(int)UserInput.Cancel, 2] = B;
            gamepad[(int)UserInput.Jab, 2] = A;
            gamepad[(int)UserInput.Strong, 2] = X;
            gamepad[(int)UserInput.Fierce, 2] = Y;
            gamepad[(int)UserInput.Move, 2] = RB;
            gamepad[(int)UserInput.Guard, 2] = LB;
            gamepad[(int)UserInput.Special, 2] = B;
        }
